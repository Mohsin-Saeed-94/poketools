...
class ScriptCommand(Enum):
    ...
    GIVEITEM = bytes.fromhex('44')

    # Removes quantity of item index from the player's Bag.
    TAKEITEM = bytes.fromhex('45')
    ...
    GIVEDECORATION = bytes.fromhex('4B')
    ...
    TAKEDECORATION = bytes.fromhex('4C')
    ...
    TRAINERBATTLE_0 = bytes.fromhex('5C 00')
    TRAINERBATTLE_1 = bytes.fromhex('5C 01')
    TRAINERBATTLE_2 = bytes.fromhex('5C 02')
    TRAINERBATTLE_3 = bytes.fromhex('5C 03')
    TRAINERBATTLE_4 = bytes.fromhex('5C 04')
    TRAINERBATTLE_5 = bytes.fromhex('5C 05')
    TRAINERBATTLE_6 = bytes.fromhex('5C 06')
    TRAINERBATTLE_7 = bytes.fromhex('5C 07')
    TRAINERBATTLE_8 = bytes.fromhex('5C 08')
    ...
    GIVECOINS = bytes.fromhex('B4')

    TAKECOINS = bytes.fromhex('B5')
...
command_lengths: Dict[ScriptCommand, int] = {
    ...
    ScriptCommand.GIVEITEM: 5,
    ScriptCommand.TAKEITEM: 5,
    ScriptCommand.CHECKITEMSPACE: 5,
    ScriptCommand.CHECKITEM: 5,
    ScriptCommand.CHECKITEMTYPE: 3,
    ScriptCommand.GIVEPCITEM: 5,
    ScriptCommand.CHECKPCITEM: 5,
    ScriptCommand.GIVEDECORATION: 3,
    ScriptCommand.TAKEDECORATION: 3,
    ...
    # Trainer battles have 9 different types.  They start with a 6 byte header,
    # followed by 1-4 pointers.
    ScriptCommand.TRAINERBATTLE_0: 6 + 8,
    ScriptCommand.TRAINERBATTLE_1: 6 + 12,
    ScriptCommand.TRAINERBATTLE_2: 6 + 12,
    ScriptCommand.TRAINERBATTLE_3: 6 + 4,
    ScriptCommand.TRAINERBATTLE_4: 6 + 12,
    ScriptCommand.TRAINERBATTLE_5: 6 + 8,
    ScriptCommand.TRAINERBATTLE_6: 6 + 16,
    ScriptCommand.TRAINERBATTLE_7: 6 + 12,
    ScriptCommand.TRAINERBATTLE_8: 6 + 16,
    ...
    ScriptCommand.GIVEMONEY: 6,
    ScriptCommand.TAKEMONEY: 6,
    ScriptCommand.CHECKMONEY: 6,
    ScriptCommand.SHOWMONEYBOX: 3,
    ScriptCommand.HIDEMONEYBOX: 3,
    ScriptCommand.UPDATEMONEYBOX: 3,
    ...
    ScriptCommand.GIVECOINS: 3,
    ScriptCommand.TAKECOINS: 3,
