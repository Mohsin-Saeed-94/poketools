...
class ScriptCommand(Enum):
    ...
    # In FireRed, this command is a nop.
    DODAILYEVENTS = bytes.fromhex('2D')
    ...
    ADDDECOR = bytes.fromhex('4B')

    # In FireRed, this command is a nop. (The argument is read, but not used for anything.)
    REMOVEDECOR = bytes.fromhex('4C')

    # In FireRed, this command is a nop. (The argument is read, but not used for anything.)
    HASDECOR = bytes.fromhex('4D')

    # In FireRed, this command is a nop. (The argument is read, but not used for anything.)
    CHECKDECOR = bytes.fromhex('4E')
    ...
    SHOWOBJECT = bytes.fromhex('58')

    HIDEOBJECT = bytes.fromhex('59')
    ...
    TRAINERBATTLE_EARLY_RIVAL = bytes.fromhex('5C 09')

    # Starts a trainer battle using the battle information stored in RAM (usually by trainerbattle, which actually calls this command behind-the-scenes), and blocks script execution until the battle finishes.
    BATTLEBEGIN = bytes.fromhex('5D')

    ONTRAINERBATTLEEND = bytes.fromhex('5E')

    ONTRAINERBATTLEENDGOTO = bytes.fromhex('5F')
    ...
    MOVEOBJECTOFFSCREEN = bytes.fromhex('64')
    ...
    GETPARTYMONNAME = bytes.fromhex('7F')
    ...
    GETSTDSTRING = bytes.fromhex('84')

    # Copies the string at offset to the specified buffer.
    GETSTRING = bytes.fromhex('85')
    ...
    SETFIELDEFFECTARG = bytes.fromhex('9D')
    ...
    SETDOORCLOSED2 = bytes.fromhex('B0')
    ...
    GETBRAILLESTRINGWIDTH = bytes.fromhex('D3')

    BUFFERITEMNAMEPLURAL = bytes.fromhex('D4')
...
command_lengths: Dict[ScriptCommand, int] = {
    ...
    ScriptCommand.INITCLOCK: 1,
    ScriptCommand.DODAILYEVENTS: 1,
    ...
    ScriptCommand.ADDDECOR: 3,
    ScriptCommand.REMOVEDECOR: 3,
    ScriptCommand.HASDECOR: 3,
    ...
    ScriptCommand.SHOWOBJECT: 5,
    ScriptCommand.HIDEOBJECT: 5,
    ScriptCommand.FACEPLAYER: 1,
    ScriptCommand.TURNOBJECT: 4,
    # Trainer battles have 10 different types.  They start with a 6 byte header,
    ...
    ScriptCommand.TRAINERBATTLE_EARLY_RIVAL: 6 + 8,
    ScriptCommand.BATTLEBEGIN: 1,
    ScriptCommand.ONTRAINERBATTLEEND: 1,
    ScriptCommand.ONTRAINERBATTLEENDGOTO: 1,
    ...
    ScriptCommand.MOVEOBJECTOFFSCREEN: 3,
    ...
    ScriptCommand.DRAWBOXTEXT: 1,
    ScriptCommand.DRAWMONPIC: 5,
    ScriptCommand.ERASEMONPIC: 1,
    ScriptCommand.DRAWCONTESTWINNER: 2,
    ...
    ScriptCommand.GETSPECIESNAME: 4,
    ScriptCommand.GETFIRSTPARTYMONNAME: 2,
    ScriptCommand.GETPARTYMONNAME: 4,
    ScriptCommand.GETITEMNAME: 4,
    ScriptCommand.GETDECORNAME: 4,
    ScriptCommand.GETMOVENAME: 4,
    ScriptCommand.GETNUMBERSTRING: 4,
    ScriptCommand.GETSTDSTRING: 4,
    ScriptCommand.GETSTRING: 6,
    ScriptCommand.POKEMART: 5,
    ScriptCommand.POKEMARTDECOR: 5,
    ScriptCommand.POKEMARTBP: 5,
    ScriptCommand.PLAYSLOTMACHINE: 3,
    ScriptCommand.PLANTBERRYTREE: 1,
    ScriptCommand.CHOOSECONTESTPKMN: 1,
    ...
    ScriptCommand.GETPRICEREDUCTION: 1,
    ...
    ScriptCommand.SETFIELDEFFECTARG: 4,
    ...
    ScriptCommand.SETDOORCLOSED2: 5,
    ScriptCommand.ADDELEVMENUITEM: 1,
