 ...
 *     destination="csv:///%kernel.project_dir%/resources/data/pokeblock_color.csv",
 *     destinationIds={@IdField(name="identifier", type="string")}
 * )
 */
class PokeblockColor extends AbstractDataMigration implements DataMigrationInterface
{
...
SELECT "contest_types"."id",
       "contest_type_names"."color" AS "name"
FROM "contest_types"
